...
var args26390 = [];
var len__19515__auto___26394 = arguments.length;
var i__19516__auto___26395 = (0);
while(true){
if((i__19516__auto___26395 < len__19515__auto___26394)){
args26390.push((arguments[i__19516__auto___26395]));

var G__26396 = (i__19516__auto___26395 + (1));
i__19516__auto___26395 = G__26396;
continue;
} else {
}
break;
...
var G__26393 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__26393,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__26393;
}
});
...
var or__18445__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__19515__auto___26401 = arguments.length;
var i__19516__auto___26402 = (0);
while(true){
if((i__19516__auto___26402 < len__19515__auto___26401)){
args__19522__auto__.push((arguments[i__19516__auto___26402]));

var G__26403 = (i__19516__auto___26402 + (1));
i__19516__auto___26402 = G__26403;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__19523__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq26398){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__26399,G__26400,seq26398__$2);
});
...
var file = cljs.core.get.call(null,map__26407__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__26407__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26407__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__26407,map__26407__$1,file,line,column){
return (function (p1__26404_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__26404_SHARP_));
});})(map__26407,map__26407__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__19370__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__19370__auto__,prefer_table__19371__auto__,method_cache__19372__auto__,cached_hierarchy__19373__auto__,hierarchy__19374__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__18445__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__18445__auto__)){
return or__18445__auto__;
} else {
...
var temp__4657__auto___26409 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___26409)){
var message_26410 = temp__4657__auto___26409;
cljs.core.println.call(null,message_26410);
} else {
}
...
var temp__4657__auto___26411 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___26411)){
var message_26412 = temp__4657__auto___26411;
cljs.core.println.call(null,message_26412);
} else {
}
...
var temp__4655__auto__ = (function (){var and__18433__auto__ = typeof exception.stack === 'string';
if(and__18433__auto__){
var G__26418 = exception.stack;
var G__26418__$1 = (((G__26418 == null))?null:clojure.string.split_lines.call(null,G__26418));
var G__26418__$2 = (((G__26418__$1 == null))?null:cljs.core.get.call(null,G__26418__$1,depth));
if((G__26418__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__26418__$2);
}
} else {
...
var vec__26419 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__26419,(0),null);
var column = cljs.core.nth.call(null,vec__26419,(1),null);
var vec__26420 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__26420,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__26420,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__26420,(2),null);
...
var m__$1 = (function (){var G__26422 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__26422) {
case "fail":
...
var G__26428 = (function (){var G__26427 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__26427);
} else {
return G__26427;
}
})();
...
return cljs.core.vary_meta.call(null,G__26430,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e26433){var e = e26433;
var G__26434 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__26434) {
...
var vec__26437 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__26437,(0),null);
var types = vec__26437;
...
return cljs.core.map.call(null,(function (p__26445){
var vec__26446 = p__26445;
var ns = cljs.core.nth.call(null,vec__26446,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__26446,(1),null);
return ((function (vec__26446,ns,vars__$1){
return (function (){
...
var G__26447 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__26447) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__26447,env,once_fixtures,each_fixtures,vec__26446,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__26447,env,once_fixtures,each_fixtures,vec__26446,ns,vars__$1){
return (function (){
var seq__26448 = cljs.core.seq.call(null,vars__$1);
var chunk__26449 = null;
var count__26450 = (0);
var i__26451 = (0);
while(true){
if((i__26451 < count__26450)){
var v = cljs.core._nth.call(null,chunk__26449,i__26451);
var temp__4657__auto___26453 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___26453)){
var t_26454 = temp__4657__auto___26453;
each_fixture_fn.call(null,((function (seq__26448,chunk__26449,count__26450,i__26451,t_26454,temp__4657__auto___26453,v,each_fixture_fn,G__26447,env,once_fixtures,each_fixtures,vec__26446,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26454)));
});})(seq__26448,chunk__26449,count__26450,i__26451,t_26454,temp__4657__auto___26453,v,each_fixture_fn,G__26447,env,once_fixtures,each_fixtures,vec__26446,ns,vars__$1))
);
} else {
}
...
var c__19256__auto__ = cljs.core.chunk_first.call(null,seq__26448__$1);
var G__26459 = cljs.core.chunk_rest.call(null,seq__26448__$1);
var G__26460 = c__19256__auto__;
var G__26461 = cljs.core.count.call(null,c__19256__auto__);
var G__26462 = (0);
seq__26448 = G__26459;
...
var v = cljs.core.first.call(null,seq__26448__$1);
var temp__4657__auto___26463__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___26463__$1)){
var t_26464 = temp__4657__auto___26463__$1;
each_fixture_fn.call(null,((function (seq__26448,chunk__26449,count__26450,i__26451,t_26464,temp__4657__auto___26463__$1,v,seq__26448__$1,temp__4657__auto__,each_fixture_fn,G__26447,env,once_fixtures,each_fixtures,vec__26446,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26464)));
});})(seq__26448,chunk__26449,count__26450,i__26451,t_26464,temp__4657__auto___26463__$1,v,seq__26448__$1,temp__4657__auto__,each_fixture_fn,G__26447,env,once_fixtures,each_fixtures,vec__26446,ns,vars__$1))
);
} else {
}

var G__26465 = cljs.core.next.call(null,seq__26448__$1);
var G__26466 = null;
var G__26467 = (0);
var G__26468 = (0);
seq__26448 = G__26465;
chunk__26449 = G__26466;
count__26450 = G__26467;
i__26451 = G__26468;
continue;
}
} else {
...
});})(each_fixture_fn,G__26447,env,once_fixtures,each_fixtures,vec__26446,ns,vars__$1))
);
});})(each_fixture_fn,G__26447,env,once_fixtures,each_fixtures,vec__26446,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1467412220487