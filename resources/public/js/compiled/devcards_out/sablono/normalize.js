...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__24942_SHARP_){
return ((p1__24942_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__24942_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__24944,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__24944;
}
});
...
var len__19515__auto___24947 = arguments.length;
var i__19516__auto___24948 = (0);
while(true){
if((i__19516__auto___24948 < len__19515__auto___24947)){
args__19522__auto__.push((arguments[i__19516__auto___24948]));

var G__24949 = (i__19516__auto___24948 + (1));
i__19516__auto___24948 = G__24949;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__19523__auto__);
});
...
var G__24946 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__24946,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__24946;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq24945){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24945));
});
/**
...
var vec__24953 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__24953,(0),null);
var names = cljs.core.nth.call(null,vec__24953,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__24953,tag_name,names){
return (function (p1__24950_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__24950_SHARP_));
});})(matches,vec__24953,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__24953,tag_name,names){
return (function (p1__24951_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__24951_SHARP_));
});})(matches,vec__24953,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__24954){
var vec__24957 = p__24954;
var tag = cljs.core.nth.call(null,vec__24957,(0),null);
var content = cljs.core.nthnext.call(null,vec__24957,(1));
...
var vec__24958 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__24958,(0),null);
var id = cljs.core.nth.call(null,vec__24958,(1),null);
var class$ = cljs.core.nth.call(null,vec__24958,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1467412219261