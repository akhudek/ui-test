...
var x__19108__auto__ = (((x == null))?null:x);
var m__19109__auto__ = (sablono.util.to_str[goog.typeOf(x__19108__auto__)]);
if(!((m__19109__auto__ == null))){
return m__19109__auto__.call(null,x);
} else {
var m__19109__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__19109__auto____$1 == null))){
return m__19109__auto____$1.call(null,x);
} else {
...
var x__19108__auto__ = (((x == null))?null:x);
var m__19109__auto__ = (sablono.util.to_uri[goog.typeOf(x__19108__auto__)]);
if(!((m__19109__auto__ == null))){
return m__19109__auto__.call(null,x);
} else {
var m__19109__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__19109__auto____$1 == null))){
return m__19109__auto____$1.call(null,x);
} else {
...
var len__19515__auto___24932 = arguments.length;
var i__19516__auto___24933 = (0);
while(true){
if((i__19516__auto___24933 < len__19515__auto___24932)){
args__19522__auto__.push((arguments[i__19516__auto___24933]));

var G__24934 = (i__19516__auto___24933 + (1));
i__19516__auto___24933 = G__24934;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__19523__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq24931){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24931));
});
/**
...
var vec__24936 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__24936,(0),null);
var words = cljs.core.nthnext.call(null,vec__24936,(1));
...
var G__24938 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__24938,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__24938;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__24939_SHARP_){
if(typeof p1__24939_SHARP_ === 'string'){
return p1__24939_SHARP_;
} else {
return cljs.core.seq.call(null,p1__24939_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__18445__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1467412219204