...
if((i < len)){
var k = (ks[i]);
var G__21062 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__21063 = (i + (1));
m = G__21062;
i = G__21063;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__21067 = c;
var G__21067__$1 = (((G__21067 == null))?null:G__21067.prototype);
if((G__21067__$1 == null)){
return null;
} else {
return (G__21067__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__21071 = c;
var G__21071__$1 = (((G__21071 == null))?null:G__21071.prototype);
if((G__21071__$1 == null)){
return null;
} else {
return (G__21071__$1["render"]);
}
})()));
});
...
return (function() { 
var G__21075__delegate = function (args){
...
while (G__21076__i < G__21076__a.length) {G__21076__a[G__21076__i] = arguments[G__21076__i + 0]; ++G__21076__i;}
  args = new cljs.core.IndexedSeq(G__21076__a,0);
} 
return G__21075__delegate.call(this,args);};
G__21075.cljs$lang$maxFixedArity = 0;
G__21075.cljs$lang$applyTo = (function (arglist__21077){
var args = cljs.core.seq(arglist__21077);
return G__21075__delegate(args);
});
...
var _STAR_current_component_STAR_21080 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_21080;
}});
...
var G__21084 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__21084) {
...
var or__18445__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__21086_21088 = (c["cljsRatom"]);
if((G__21086_21088 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__21086_21088);
}
...
if(cljs.core.truth_((function (){var and__18433__auto__ = wrap;
...
if(((1) === cljs.core.count.call(null,renders_21091))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_21092)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_21092))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__18445__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__18445__auto__)){
return or__18445__auto__;
} else {
...
var render_fun__$1 = (function (){var or__18445__auto__ = render_fun;
if(cljs.core.truth_(or__18445__auto__)){
return or__18445__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__18445__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__18445__auto__)){
return or__18445__auto__;
} else {
...
var name__$1 = (function (){var G__21090 = name;
switch (G__21090) {
case "":
...
var G__21095 = o;
(G__21095[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__21101 = (function (){var or__18445__auto__ = (function (){var G__21103 = c;
if((G__21103 == null)){
return null;
} else {
return (G__21103["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__18445__auto__)){
return or__18445__auto__;
...
return (G__21101["_currentElement"]);
}
})();
var name = (function (){var G__21104 = elem;
var G__21104__$1 = (((G__21104 == null))?null:(G__21104["type"]));
if((G__21104__$1 == null)){
return null;
} else {
return (G__21104__$1["displayName"]);
}
})();
var path = (function (){var G__21105 = elem;
var G__21105__$1 = (((G__21105 == null))?null:(G__21105["_owner"]));
var G__21105__$2 = (((G__21105__$1 == null))?null:reagent$impl$component$component_path.call(null,G__21105__$1));
if((G__21105__$2 == null)){
return null;
} else {
return [cljs.core.str(G__21105__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__18445__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__18445__auto__)){
return or__18445__auto__;
} else {
var G__21107 = c;
var G__21107__$1 = (((G__21107 == null))?null:G__21107.constructor);
if((G__21107__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__21107__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1467412216876