...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19051__auto__,writer__19052__auto__,opt__19053__auto__){
return cljs.core._write.call(null,writer__19052__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__21111 = o;
(G__21111[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__21112__delegate = function (args){
...
while (G__21113__i < G__21113__a.length) {G__21113__a[G__21113__i] = arguments[G__21113__i + 0]; ++G__21113__i;}
  args = new cljs.core.IndexedSeq(G__21113__a,0);
} 
...
var args = cljs.core.seq(arglist__21114);
...
if(cljs.core.truth_((function (){var and__18433__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__18433__auto__){
var and__18433__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__18433__auto____$1){
var and__18433__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__21119 = jsprops;
(G__21119["defaultValue"] = value);

(G__21119["onChange"] = ((function (G__21119,v,value,on_change){
return (function (p1__21117_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21117_SHARP_);
});})(G__21119,v,value,on_change))
);
...
var vec__21124 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21124,(0),null);
var id = cljs.core.nth.call(null,vec__21124,(1),null);
var class$ = cljs.core.nth.call(null,vec__21124,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___21127 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___21127 == null)){
} else {
var key_21128 = temp__4661__auto___21127;
(jsprops["key"] = key_21128);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__21130 = (new reagent.impl.template.NativeWrapper());
(G__21130["name"] = c);
...
var len__19515__auto___21136 = arguments.length;
var i__19516__auto___21137 = (0);
while(true){
if((i__19516__auto___21137 < len__19515__auto___21136)){
args__19522__auto__.push((arguments[i__19516__auto___21137]));

var G__21138 = (i__19516__auto___21137 + (1));
i__19516__auto___21137 = G__21138;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19523__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21134){
var G__21135 = cljs.core.first.call(null,seq21134);
var seq21134__$1 = cljs.core.next.call(null,seq21134);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__21135,seq21134__$1);
});
...
break;
default:
var G__21142 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__21142;
continue;
...
var n__19360__auto___21145 = a.length;
var i_21146 = (0);
while(true){
if((i_21146 < n__19360__auto___21145)){
(a[i_21146] = reagent.impl.template.as_element.call(null,(a[i_21146])));

var G__21147 = (i_21146 + (1));
i_21146 = G__21147;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19360__auto___21148 = a.length;
var i_21149 = (0);
while(true){
if((i_21149 < n__19360__auto___21148)){
var val_21150 = (a[i_21149]);
if((cljs.core.vector_QMARK_.call(null,val_21150)) && ((reagent.impl.template.key_from_vec.call(null,val_21150) == null))){
(o["no-key"] = true);
} else {
}

(a[i_21149] = reagent.impl.template.as_element.call(null,val_21150));

var G__21151 = (i_21149 + (1));
i_21149 = G__21151;
continue;
} else {
}
...
var ctx = {};
var vec__21153 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21153,(0),null);
var derefed = cljs.core.nth.call(null,vec__21153,(1),null);
...
var G__21155 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21155) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__21155){
...
//# sourceMappingURL=template.js.map?rel=1467412217015